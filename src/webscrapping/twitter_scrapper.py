...
def launch():
    # companies that we are interesed on webscrapping
    # companies_string = "BP PLC, S&P 500 ENERGY INDEX, INTERNATIONAL PAPER CO, ALTAGAS LTD, SUNOCO LP, CORTEVA INC, STORA ENSO OYJ-R SHS, NEWMONT CORP,  EXXON MOBIL CORP, CONOCOPHILLIPS, TOTALENERGIES SE, UPM-KYMMENE OYJ, VALERO ENERGY CORP, NUCOR CORP, BARRICK GOLD CORP, FMC CORP, FREEPORT-MCMORAN INC, ARCHER-DANIELS-MIDLAND CO, POSCO HOLDINGS INC -SPON ADR, BHP GROUP LTD-SPON ADR, TECK RESOURCES LTD-CLS B, RIO TINTO PLC-SPON ADR, WILMAR INTERNATIONAL LTD, MONDI PLC, ANGLO AMERICAN PLC, CENOVUS ENERGY INC, WESTLAKE CORP, GLENCORE PLC, MOSAIC CO/THE, MARATHON PETROLEUM CORP,PHILLIPS 66, WEYERHAEUSER CO, ENERGY TRANSFER LP, VIPER ENERGY PARTNERS LP, WESTROCK CO, PEMBINA PIPELINE CORP, ALCOA CORP, ARCELORMITTAL, NUTRIEN LTD, NUTRIEN LTD, DOW INC, OCCIDENTAL PETROLEUM CORP, ONEOK INC, CHEVRON CORP, PIONEER NATURAL RESOURCES CO, TARGA RESOURCES CORP, SCHLUMBERGER LTD, BAKER HUGHES CO, DEVON ENERGY CORP, HESS CORP, MARATHON OIL CORP, WILLIAMS COS INC, COTERRA ENERGY INC, APA CORP, EOG RESOURCES INC, KINDER MORGAN INC, EQT CORP, HALLIBURTON CO, DIAMONDBACK ENERGY INC, "
    companies_string = "CONOCOPHILLIPS"
    companies_list = companies_string.split(",")
    for i in companies_list:
        output_path = (
            f"./../../data/webscraped_data/webscraped_{'_'.join(i.split())}.csv"
        )
